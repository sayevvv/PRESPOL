    ...
    <main class="flex-2 lg:overflow-y-auto md:w-[calc(100%-5rem)] lg:w-[calc(100%-16rem)] p-4 md:p-6 pt-8 bg-white/60 md:bg-transparent">
        <div class="container mx-auto max-w-full space-y-6">
            ...
            ?>
                ...
                <section class="flex justify-between items-center bg-gradient-to-r from-orange-500 to-orange-400 text-white px-6 py-8 rounded-lg  hover:shadow-xl transform hover:scale-105 transition-all duration-300 mb-6">
                ...
                <div id="detailView" class="bg-white p-6 rounded-lg  border border-gray-300">
                    <!-- Detail Kompetisi -->
                ...
                <?php if ($user instanceof Admin): ?>
                    <!-- Edit Form -->
                    <div id="editForm" class="bg-white p-6 rounded-lg  border border-gray-300 hidden">
