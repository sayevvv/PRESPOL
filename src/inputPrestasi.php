        ...
        <main class="w-4/5 p-10">
            ...
            <form id="prestasiForm" class="space-y-4" action="InputProses.php" method="POST" enctype="multipart/form-data">
                ...
                <div>
                    ...
                    <div class="group focus-within:ring-2 focus-within:ring-slate-900 flex items-center w-full border border-gray-300 rounded-lg p-3 bg-white cursor-pointer">
